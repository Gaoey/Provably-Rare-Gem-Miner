...
userAddr = '0x57D98C203B809c6c5e215851133Ad9B9d50130a9'  # your address. this is my address (where you can donate lol)
kind = 8  # which gem ya want (Loot, Amethyst = 0 Topaz = 1 ... for Bloot Violet=10, Goldy Pebble =1 ...)
nonce = 0  # how greedy are you? JK (you can read from contract or FE)
diff = 70368744243199  # just read from the contract or front end
...
while True:
    ...
    if ix < target:
        print("(8) done! here's the salt - ", salt)
        break
    # if i % 5000 == 0:
