...
kind = 7  # which gem ya want (Loot, Amethyst = 0 Topaz = 1 ... for Bloot Violet=10, Goldy Pebble =1 ...)
nonce = 0  # how greedy are you? JK (you can read from contract or FE)
diff = 105998046201  # just read from the contract or front end
...
while True:
    ...
    if ix < target:
        print("(7) done! here's the salt - ", salt)
        break
    # if i % 5000 == 0:
